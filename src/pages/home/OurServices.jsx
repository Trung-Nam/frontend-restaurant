        ...
        <div className="section-container">
            <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                <div className="md:w-1/2">
                    <div className='text-left md:w4/5'>
                        <p className='subtitle'>Our Story & Services</p>
                        <h2 className='title'>Our Culinary Journey And Services</h2>
                        <p className='my-5 text-secondary'>
                            Rooted in passion, we curate unforgettable dining experiences and offer exceptional services, blending culinary artistry with warm hospitality.
                        </p>
                        <button className='btn bg-primary text-white rounded-full px-8 py-3'>Explore</button>
                    </div>
                </div>
                    ...
                    <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 items-center">
                        {
                            serviceLists.map((service) => (
                                <div key={service.id} className="shadow-md rounded-3xl py-5 px-4 text-center space-y-2 text-green cursor-pointer hover:border hover:border-indigo-600 transition-all duration-200">
                                    <img src={service.img} alt="service-image" className=" mx-auto" />
